...
func Test_VerifyAddFixedPriceItem_Body(t *testing.T) {
	s := VerifyAddFixedPriceItem{
		Currency:           "USD",
		Country:            "US",
		DispatchTimeMax:    1,
		ConditionID:        1,
